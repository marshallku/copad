...
final class TabViewController: NSViewController {
    ...
    func panel(id: String) -> (any NesttyPanel)? {
    ...
    init(config: NesttyConfig, theme: NesttyTheme) {
        self.config = config
        self.theme = theme
    ...
    @discardableResult
    func newPluginPanelTab(_ panel: any NesttyPanel) -> String {
    ...
    @discardableResult
    func splitActivePaneWithPluginPanel(_ panel: any NesttyPanel, orientation: SplitOrientation = .horizontal) -> String? {
    ...
    func applyConfig(_ newConfig: NesttyConfig, theme: NesttyTheme) {
