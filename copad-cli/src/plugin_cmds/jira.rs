//! `coctl jira` — ergonomic wrapper over the `jira.*` action surface.
//!
//! Maps clap subcommands onto actions exposed by `copad-plugin-jira`:
//!
//! | CLI                                       | Action                  |
//! |-------------------------------------------|-------------------------|
...
/// `copad-plugin-jira` as a dep just for one render path would invert
/// the crate ownership.
