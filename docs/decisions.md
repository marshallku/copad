...
5. **Out of scope:** trigger engine relocation (5b.2), context service relocation (5b.2), statusbar `[[modules]]` shell execution (5b.3), legacy `plugin.<name>.<cmd>` shell command execution (5b.3), GUI per-instance socket permission hardening (5b.4).
